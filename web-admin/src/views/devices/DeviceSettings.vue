...
import { getDevice, updateDevice, deleteDevice, setDeviceEnabled, resetDeviceSecret, type Device } from '@/api/device'
...
async function save() {
  ...
  const timeoutSec = form.onlineMode === 'connection' ? 0 : sec
  saving.value = true
  try {
